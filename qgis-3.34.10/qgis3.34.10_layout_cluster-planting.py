...
def run_single_company(companies_select, cluster_planting) -> None:
    ...
    def legendMainInfoValues():
        ...
        cuValue_text.attemptResize(QgsLayoutSize(9.943, 2.605, QgsUnitTypes.LayoutMillimeters))
        ...
        cuPercentage_text = QgsLayoutItemLabel(layout)
        layout.addLayoutItem(cuPercentage_text)
        cuPercentage_text.setText(str(round_cuPercentage))
        cuPercentage_text.setHAlign(Qt.AlignRight)
        cuPercentage_text.setVAlign(Qt.AlignTop)
        cuPercentage_text.setTextFormat(keyStyle)
        cuPercentage_text.attemptMove(QgsLayoutPoint(282.045, 66.029, QgsUnitTypes.LayoutMillimeters))
        cuPercentage_text.attemptResize(QgsLayoutSize(9.097, 3.030, QgsUnitTypes.LayoutMillimeters))
    ...
    addLine(layout=layout, x=218,     y=70.2,    length=74.269, orientation="horizontal")
    addLine(layout=layout, x=255.245, y=54.079,  length=16.3,  orientation="vertical")
    addLine(layout=layout, x=273.166, y=53.934,  length=16.465, orientation="vertical")
